...
class Admin extends CI_Controller {
    ...
    {
        $this->load->model('Race');
        $this->Race->add_race($this->input->post('txtName'), $this->input->post('txtLocation'), $this->input->post('txtDescription'), $this->input->post('txtDateTime'));
    ...
    {
        $this->load->model('Race');
        $this->Race->update_race($this->input->post('txtName'), $this->input->post('txtLocation'), $this->input->post('txtDescription'), $this->input->post('txtDateTime'), $this->input->post('txtID'));
        redirect("admin/manage_marathons", "refresh");
    }
