                    ...
                    <div class="col-lg-12">
                        <form method="post" action="/site/admin/edit_race" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input name="txtLocation" value="<?=$race[0]["raceLocation"]?>" class="form-control" placeholder="City, State"><br>
                            </div>

                            <div class="form-group">
                                <label>Race Description</label>
                                <textarea name="txtDescription" class="form-control" placeholder="Enter Text"><?=$race[0]["raceDescription"]?></textarea><br>
                            </div>

                            <div class="form-group">
                                <label>Race Date/Time</label>
                                <input name="txtDateTime" value="<?=$race[0]["raceDateTime"]?>" class="form-control" placeholder="YYYY-MM-DD HH:MM:SS"><br>
                            </div>
