                    ...
                    <div class="col-lg-12">
                        <form method="post" action="/site/admin/add_race" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input name="txtLocation" class="form-control" placeholder="City, State"><br>
                            </div>

                            <div class="form-group">
                                <label>Race Description</label>
                                <textarea name="txtDescription" class="form-control" placeholder="Enter Text"></textarea><br>
                            </div>

                            <div class="form-group">
                                <label>Race Date/Time</label>
                                <input name="txtDateTime" class="form-control" placeholder="YYYY-MM-DD HH:MM:SS"><br>
                            </div>
